...
function detectProvider(path6) {
  for (const [key, provider] of Object.entries(PROVIDERS)) {
    if (path6.startsWith(provider.pathPrefix)) {
      return { key, ...provider };
    }
  }
  return null;
...
// src/proxy/interceptor.js
import crypto2 from "crypto";
import fs2 from "fs";
import os from "os";
import path2 from "path";

// src/utils/parseUsage.js
function parseUsage(responseBody, schema) {
...
// src/proxy/interceptor.js
async function captureCall(db, responseBody, req, latencyMs) {
  ...
  try {
    ...
    fs2.appendFileSync(
      path2.join(os.homedir(), ".lens", "errors.log"),
...
// src/proxy/server.js
function createProxyServer(db, port = 2337) {
  const app = express();
...
import fs3 from "fs";
import os2 from "os";
var DB_DIR = path3.join(os2.homedir(), ".lens");
var DB_PATH = path3.join(DB_DIR, "lens.db");
...
import React5, { useState as useState2, useEffect as useEffect2, useRef } from "react";
...
// src/ui/components/StatusBar.jsx
function StatusBar({ sessionId, callCount, totalCost, width }) {
  ...
  return /* @__PURE__ */ React.createElement(Box, { width, justifyContent: "space-between" }, /* @__PURE__ */ React.createElement(Box, null, /* @__PURE__ */ React.createElement(Text, { color: "green" }, "\u25CF"), /* @__PURE__ */ React.createElement(Text, { color: "gray" }, " Proxy running on :2337")), /* @__PURE__ */ React.createElement(Box, null, /* @__PURE__ */ React.createElement(Text, { color: "gray" }, formatDuration(startTime, Date.now()))), /* @__PURE__ */ React.createElement(Box, null, /* @__PURE__ */ React.createElement(Text, { color: "gray" }, "q to quit")));
}

// src/ui/components/CallLog.jsx
...
function getCostColor(costUsd) {
  if (costUsd > 0.1) return "red";
  if (costUsd > 0.01) return "yellow";
  return "green";
}
function CallLog({ calls, width }) {
  const visibleCalls = calls.slice(0, 20);
  return /* @__PURE__ */ React2.createElement(Box2, { flexDirection: "column", width }, visibleCalls.map((call, index) => {
    ...
    const cache = call.cache_read_tokens > 0 ? ` [cache:${formatTokens(call.cache_read_tokens)}]` : "";
    const cost = call.isEstimated ? "?" : formatCost(call.cost_usd);
    return /* @__PURE__ */ React2.createElement(Box2, { key: call.id || index, width }, /* @__PURE__ */ React2.createElement(Text2, { color: "gray" }, "[", time, "]"), /* @__PURE__ */ React2.createElement(Text2, { color: modelColor }, " ", model), /* @__PURE__ */ React2.createElement(Text2, null, " ", input, "in ", output, "out"), cache && /* @__PURE__ */ React2.createElement(Text2, { color: "cyan" }, cache), /* @__PURE__ */ React2.createElement(Text2, { color: costColor }, " $", cost));
  }), visibleCalls.length === 0 && /* @__PURE__ */ React2.createElement(Box2, null, /* @__PURE__ */ React2.createElement(Text2, { color: "gray" }, "Waiting for calls...")));
}

// src/ui/components/SessionSummary.jsx
import React3 from "react";
import { Box as Box3, Text as Text3 } from "ink";
function SessionSummary({ summary, totalCost, callCount }) {
  return /* @__PURE__ */ React3.createElement(Box3, { flexDirection: "column", width: "100%" }, /* @__PURE__ */ React3.createElement(Text3, { bold: true }, "Session Summary"), /* @__PURE__ */ React3.createElement(Box3, { height: 1 }), summary.map((model, index) => /* @__PURE__ */ React3.createElement(Box3, { key: model.model || index, flexDirection: "column" }, /* @__PURE__ */ React3.createElement(Text3, { bold: true }, formatModelShort(model.model)), /* @__PURE__ */ React3.createElement(Text3, null, "  Input: ", formatTokens(model.totalInputTokens), " (", formatCost(model.totalInputCostUsd), ")"), /* @__PURE__ */ React3.createElement(Text3, null, "  Output: ", formatTokens(model.totalOutputTokens), " (", formatCost(model.totalOutputCostUsd), ")"), /* @__PURE__ */ React3.createElement(Text3, null, "  Calls: ", model.callCount), model.totalCacheReadTokens > 0 && /* @__PURE__ */ React3.createElement(Text3, null, "  Cache hits: ", formatTokens(model.totalCacheReadTokens), " saved"), index < summary.length - 1 && /* @__PURE__ */ React3.createElement(Box3, { height: 1 }, /* @__PURE__ */ React3.createElement(Text3, null, "\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500")))), /* @__PURE__ */ React3.createElement(Box3, { height: 1 }), /* @__PURE__ */ React3.createElement(Text3, { bold: true }, "TOTAL: ", formatCost(totalCost), " (", callCount, " calls)"));
}

// src/ui/components/CtxPanel.jsx
import React4, { useMemo } from "react";
import { Box as Box4, Text as Text4 } from "ink";
function CtxPanel({ calls }) {
  ...
  if (!ctxStats) {
    return /* @__PURE__ */ React4.createElement(Box4, { flexDirection: "column", width: "100%", marginTop: 1 }, /* @__PURE__ */ React4.createElement(Text4, { color: "gray" }, "ctx not detected"), /* @__PURE__ */ React4.createElement(Text4, { color: "gray", dimColor: true }, "Point ctx at :2337 to track savings"));
  }
  return /* @__PURE__ */ React4.createElement(Box4, { flexDirection: "column", width: "100%", marginTop: 1 }, /* @__PURE__ */ React4.createElement(Text4, { bold: true, color: "cyan" }, "ctx active"), /* @__PURE__ */ React4.createElement(Text4, null, "Before: ", formatTokens(Math.round(ctxStats.beforeAvg)), " tokens avg"), /* @__PURE__ */ React4.createElement(Text4, null, "After: ", formatTokens(Math.round(ctxStats.afterAvg)), " tokens avg"), /* @__PURE__ */ React4.createElement(Text4, null, "Saved: ", formatTokens(Math.round(ctxStats.savedTokens)), " (", ctxStats.savedPercent.toFixed(0), "%) per call"), /* @__PURE__ */ React4.createElement(Text4, null, "Est. saved: ", formatCost(ctxStats.savedCost), " this session"));
}

// src/db/queries.js
function getSessionCalls(db, sessionId) {
  return db.prepare(
...
function getRecentSessions(db, limit = 10) {
  return db.prepare(`
    SELECT 
      id,
      started_at,
...
function getAllCallsForSession(db, sessionId) {
  return db.prepare(`
    SELECT 
      timestamp,
      provider,
...
function Dashboard({ db, sessionId, eventEmitter }) {
  ...
  return /* @__PURE__ */ React5.createElement(Box5, { flexDirection: "column", width }, /* @__PURE__ */ React5.createElement(
    StatusBar,
    {
      sessionId,
      callCount,
  ...
  ), /* @__PURE__ */ React5.createElement(Box5, { flexDirection: "row" }, /* @__PURE__ */ React5.createElement(Box5, { width: logWidth }, /* @__PURE__ */ React5.createElement(CallLog, { calls, width: logWidth })), /* @__PURE__ */ React5.createElement(Box5, { width: panelWidth, flexDirection: "column", paddingLeft: 1 }, /* @__PURE__ */ React5.createElement(SessionSummary, { summary, totalCost, callCount }), /* @__PURE__ */ React5.createElement(CtxPanel, { calls }))));
}
...
`);
  ...
  const EventEmitter2 = (await import("events")).default;
  global.eventEmitter = new EventEmitter2();
  let server;
  try {
...
function setupInkDashboard(db, sessionId, eventEmitter) {
  const { waitUntilExit } = render(
    /* @__PURE__ */ React6.createElement(Dashboard, { db, sessionId, eventEmitter })
  );
  waitUntilExit().then(() => {
...
function historyCommand(options) {
  ...
  try {
    ...
    console.log(source_default.gray("Date".padEnd(20) + "Duration".padEnd(12) + "Calls".padEnd(8) + "Total Cost"));
    console.log(source_default.gray("\u2500".repeat(60)));
    for (const session of sessions) {
      const date = new Date(session.started_at).toLocaleString();
      const duration = session.ended_at ? formatDuration(session.started_at, session.ended_at) : "Active";
      const calls = session.call_count || 0;
      const cost = formatCost(session.total_cost_usd);
      console.log(
        date.padEnd(20) + duration.padEnd(12) + String(calls).padEnd(8) + cost
      );
    }
    console.log("");
  } finally {
...
function exportCommand(options) {
  ...
  try {
    ...
    if (!sessionId || sessionId === "latest") {
      ...
      if (sessions.length === 0) {
        console.log(source_default.yellow("No sessions found to export."));
        return;
      }
    ...
    if (calls.length === 0) {
      console.log(source_default.yellow(`No calls found for session ${sessionId}.`));
      return;
    }
    if (format === "csv") {
      const csvHeader = "timestamp,provider,model,input_tokens,output_tokens,cache_read_tokens,cost_usd,latency_ms";
      const csvRows = calls.map(
        (call) => `${new Date(call.timestamp).toISOString()},${call.provider},${call.model},${call.input_tokens},${call.output_tokens},${call.cache_read_tokens},${call.cost_usd},${call.latency_ms}`
      );
      const csvContent = [csvHeader, ...csvRows].join("\n");
      const filename = `lens-export-${sessionId}.csv`;
      const filepath = path4.resolve(filename);
      fs4.writeFileSync(filepath, csvContent);
      console.log(source_default.green(`Exported ${calls.length} calls to ${filepath}`));
    } else {
      console.log(source_default.yellow(`Unsupported format: ${format}. Use csv.`));
    }
  } finally {
    db.close();
  }
...
function modelsCommand() {
  ...
  console.log(source_default.gray("Model".padEnd(40) + "Input/1M".padEnd(12) + "Output/1M".padEnd(12) + "Provider"));
  ...
  for (const [model, price] of models) {
    ...
    console.log(
      model.padEnd(40) + input.padEnd(12) + output.padEnd(12) + provider
    );
  }
...
program2.name("lens").description("Real-time token usage and cost monitor for AI agent workflows").version("0.1.0");
program2.command("start").description("Start Lens proxy server and dashboard").option("-p, --port <port>", "Port to run proxy on", "2337").option("--no-ui", "Run without terminal UI (JSON line mode)").action(startCommand);
program2.command("history").description("View recent session history").option("-l, --limit <limit>", "Number of sessions to show", "10").action(historyCommand);
program2.command("export").description("Export session call log to CSV").option("-s, --session <session>", "Session ID to export (default: latest)").option("-f, --format <format>", "Export format (csv)", "csv").action(exportCommand);
program2.command("clear").description("Delete all stored data").option("--confirm", "Confirm deletion").action((options) => {
  if (!options.confirm) {
    console.log("Run with --confirm to delete all Lens data.");
    process.exit(0);
  }
  const dbPath = path5.join(os4.homedir(), ".lens", "lens.db");
...
program2.command("models").description("Print supported models and pricing").action(modelsCommand);
program2.parse();
